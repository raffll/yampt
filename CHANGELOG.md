...
- [NEW] Plugins and records excluded from the merged patch now show a grey background in the navigation tree, so an excluded plugin, its records, and any single record matched by the exclusion pattern stand out at a glance
