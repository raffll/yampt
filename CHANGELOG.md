...
- [CHANGE] Landscape (LAND) records are never written to the merged patch, since landscape is bulk terrain data that the merge cannot combine meaningfully. Landscape records still appear in the navigation tree so conflicts remain visible
