...
yampt.exe --make-not --add-hyperlinks --add-annotations -f %ESM% -d "%BASE%\%DICT_N%" "%GLOS%"
yampt.exe --make-changed --add-hyperlinks --add-annotations -f %ESM% -d "%BASE%\%DICT_F%" "%GLOS%"
