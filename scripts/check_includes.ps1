...
$coreFiles = Get-ChildItem -Path (Join-Path $repoRoot "yampt.core\source") -Recurse -Include "*.hpp","*.cpp"
...
$qtFiles = Get-ChildItem -Path (Join-Path $repoRoot "yampt.qt\source") -Recurse -Include "*.hpp","*.cpp"
...
# yampt.cli: no Qt
$cliFiles = Get-ChildItem -Path (Join-Path $repoRoot "yampt.cli\source") -Recurse -Include "*.hpp","*.cpp"
