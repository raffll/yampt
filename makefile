SOURCES=Main.cpp EsmReader.cpp EsmRecord.cpp DictCreator.cpp DictReader.cpp DictMerger.cpp EsmConverter.cpp Config.cpp UserInterface.cpp DictTools.cpp
EXECUTABLE=yampt
