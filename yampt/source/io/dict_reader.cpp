...
void dict_reader_t::parse_record(yyjson_val * record, tools_t::rec_type_t type, const std::string & type_str)
{
...
void dict_reader_t::parse_chapter(yyjson_val * array, tools_t::rec_type_t type, const std::string & type_str)
{
