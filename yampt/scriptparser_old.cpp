...
//----------------------------------------------------------
ScriptParserOld::ScriptParserOld()
{
...
//----------------------------------------------------------
void ScriptParserOld::convertScript()
{
...
//----------------------------------------------------------
void ScriptParserOld::stripLastNewLineChars()
{
...
//----------------------------------------------------------
std::string ScriptParserOld::checkLine(
...
//----------------------------------------------------------
std::string ScriptParserOld::convertLine(const std::string & line)
{
    std::string new_line = line;
...
//----------------------------------------------------------
std::string ScriptParserOld::findInnerTextInDict(
...
//----------------------------------------------------------
std::string ScriptParserOld::convertInnerTextInLine(
    const std::string & line,
    const std::string & text,
...
//----------------------------------------------------------
void ScriptParserOld::convertLineInCompiledScriptData(
    const std::string & line,
...
//----------------------------------------------------------
void ScriptParserOld::convertInnerTextInCompiledScriptData(
    const std::string & text,
    const std::string & new_text,
    const bool is_getpccell)
{
...
//----------------------------------------------------------
std::pair<std::string, size_t> ScriptParserOld::extractInnerTextFromLine(
    const std::string & line,
    const size_t keyword_pos,
    const int pos_in_expression)
{
...
//----------------------------------------------------------
std::vector<std::string> ScriptParserOld::splitLine(
    const std::string & line,
    const size_t keyword_pos,
    const bool is_say)
{
