...
#include "../yampt.translator/controller/annotation_manager.hpp"
...
TEST_CASE("annotation_manager_t::annotate, finds dial topic in text", "[u]")
{
	auto dict = make_dict_with_dial({ { "kwama forager", "zwiadowca kwama" } });
	annotation_manager_t manager;
...
TEST_CASE("annotation_manager_t::annotate, case insensitive matching", "[u]")
{
...
TEST_CASE("annotation_manager_t::annotate, no match inside word", "[u]")
{
...
TEST_CASE("annotation_manager_t::annotate, empty text returns empty", "[u]")
{
...
TEST_CASE("annotation_manager_t::annotate, glossary does not overlap hyperlinks", "[u]")
{
	tools_t::dict_t dict;
...
TEST_CASE("annotation_manager_t::annotate, multiple matches in text", "[u]")
{
	auto dict = make_dict_with_dial({ { "test", "test_pl" } });
	annotation_manager_t manager;
	manager.rebuild({ { &dict, "base.json" } });
...
TEST_CASE("annotation_manager_t::annotate, skips excluded statuses for glossary", "[u]")
{
	auto dict = make_dict_with_fnam({ { "Sword", "Miecz" } }, "changed");
	annotation_manager_t manager;
	manager.rebuild({ { &dict, "base.json" } });
...
TEST_CASE("annotation_manager_t::annotate, includes adapted status in glossary", "[u]")
{
	auto dict = make_dict_with_fnam({ { "Sword", "Miecz" } }, "adapted");
	annotation_manager_t manager;
	manager.rebuild({ { &dict, "base.json" } });
...
TEST_CASE("annotation_manager_t::find_glossary_matches, word boundary check", "[u]")
{
...
TEST_CASE("annotation_manager_t::find_glossary_matches, no overlap between terms", "[u]")
{
...
TEST_CASE("annotation_manager_t::apply_glossary, replaces matched terms", "[u]")
{
	auto dict = make_dict_with_fnam({ { "sword", "miecz" } });
	annotation_manager_t manager;
	manager.rebuild({ { &dict, "base.json" } });
...
TEST_CASE("annotation_manager_t::apply_glossary, replaces multiple occurrences", "[u]")
{
...
TEST_CASE("annotation_manager_t::apply_glossary, respects word boundaries", "[u]")
{
...
TEST_CASE("annotation_manager_t::update_term, updates existing glossary entry", "[u]")
{
	auto dict = make_dict_with_fnam({ { "sword", "miecz" } });
	annotation_manager_t manager;
	manager.rebuild({ { &dict, "base.json" } });
...
TEST_CASE("annotation_manager_t::update_term, removes entry when new equals old", "[u]")
{
	auto dict = make_dict_with_fnam({ { "sword", "miecz" } });
	annotation_manager_t manager;
	manager.rebuild({ { &dict, "base.json" } });
...
TEST_CASE("annotation_manager_t::update_term, adds new dial topic", "[u]")
{
	tools_t::dict_t dict;
	annotation_manager_t manager;
	manager.rebuild({ { &dict, "base.json" } });
...
TEST_CASE("annotation_manager_t::annotate_translated, finds translated topic in text", "[u]")
{
	auto dict = make_dict_with_dial({ { "kwama forager", "zwiadowca kwama" } });
	annotation_manager_t manager;
	manager.rebuild({ { &dict, "base.json" } });
...
TEST_CASE("annotation_manager_t::rebuild, longer terms match first", "[u]")
{
...
TEST_CASE("annotation_manager_t::get_speaker_gender, returns empty for unknown npc", "[u]")
{
	annotation_manager_t manager;
...
TEST_CASE("annotation_manager_t::has_enchantment, returns false when empty", "[u]")
{
	annotation_manager_t manager;
