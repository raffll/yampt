...
TEST_CASE("eet_converter_t::map_type, exhaustive type mapping", "[u]")
{
	...
	const std::vector<mapping_t> known_mappings = {
		{"NPC_", "FNAM", tools_t::rec_type_t::fnam},
		{"SPEL", "FNAM", tools_t::rec_type_t::fnam},
		{"ARMO", "FNAM", tools_t::rec_type_t::fnam},
		{"BOOK", "FNAM", tools_t::rec_type_t::fnam},
		{"CONT", "FNAM", tools_t::rec_type_t::fnam},
		{"MISC", "FNAM", tools_t::rec_type_t::fnam},
		{"CLOT", "FNAM", tools_t::rec_type_t::fnam},
		{"CREA", "FNAM", tools_t::rec_type_t::fnam},
		{"ALCH", "FNAM", tools_t::rec_type_t::fnam},
		{"DOOR", "FNAM", tools_t::rec_type_t::fnam},
		{"ACTI", "FNAM", tools_t::rec_type_t::fnam},
		{"LIGH", "FNAM", tools_t::rec_type_t::fnam},
		{"INGR", "FNAM", tools_t::rec_type_t::fnam},
		{"CLAS", "FNAM", tools_t::rec_type_t::fnam},
		{"FACT", "FNAM", tools_t::rec_type_t::fnam},
		{"APPA", "FNAM", tools_t::rec_type_t::fnam},
		{"REPA", "FNAM", tools_t::rec_type_t::fnam},
		{"CELL", "NAME", tools_t::rec_type_t::cell},
		{"REGN", "NAME", tools_t::rec_type_t::cell},
		{"PGRD", "NAME", tools_t::rec_type_t::cell},
		{"CELL", "FNAM", tools_t::rec_type_t::cell},
		{"REGN", "FNAM", tools_t::rec_type_t::cell},
		{"CELL", "DNAM", tools_t::rec_type_t::cell},
		{"NPC_", "DNAM", tools_t::rec_type_t::fnam},
		{"NPC_", "CNDT", tools_t::rec_type_t::fnam},
		{"BOOK", "TEXT", tools_t::rec_type_t::text},
		{"SCPT", "SCTX", tools_t::rec_type_t::sctx},
		{"SCPT", "MSGB", tools_t::rec_type_t::bnam},
		{"SCPT", "CELL", tools_t::rec_type_t::bnam},
		{"SCPT", "SAY_", tools_t::rec_type_t::bnam},
		{"SCPT", "DIAL", tools_t::rec_type_t::bnam},
		{"MGEF", "DESC", tools_t::rec_type_t::desc},
		{"CLAS", "DESC", tools_t::rec_type_t::desc},
		{"FACT", "RNAM", tools_t::rec_type_t::rnam},
		{"GMST", "STRV", tools_t::rec_type_t::gmst},
		{"DIAL", "NAME", tools_t::rec_type_t::dial},
	};
