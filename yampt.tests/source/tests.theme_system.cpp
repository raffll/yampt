...
TEST_CASE("theme_system_t::get_color, dark backward compat", "[u]")
{
	...
	check(color_name_t::annotation_inflection, 60, 45, 70);
...
{
	const auto path = settings_store_t::settings_dir() + "/test_theme_settings.ini";
...
{
	const auto path = settings_store_t::settings_dir() + "/test_theme_empty.ini";
	QFile::remove(path);
...
{
	const auto path = settings_store_t::settings_dir() + "/test_theme_invalid.ini";
...
TEST_CASE("theme_system_t::get_color, light backward compat", "[u]")
{
	...
	check(color_name_t::annotation_inflection, 160, 110, 200, 60);
