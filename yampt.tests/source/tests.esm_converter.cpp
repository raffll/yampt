...
{
	auto merger = make_merger_with_entry(rec_type_t::cell, "", "", "Something");
...
{
	auto merger = make_merger_with_entry(rec_type_t::fnam, "NPC_^fargoth", "Fargoth", "Fargoth PL");
...
{
	auto merger = make_merger_with_entry(rec_type_t::fnam, "NPC_^player", "Player", "Gracz");
...
{
	auto merger = make_merger_with_entry(rec_type_t::gmst, "sWelcome", "Welcome", "Witaj");
...
{
	auto merger = make_merger_with_entry(rec_type_t::gmst, "iMaxLevel", "100", "200");
...
{
	auto merger = make_merger_with_entry(rec_type_t::dial, "background", "background", "tlo");
...
{
	auto merger = make_merger_with_entry(rec_type_t::dial, "quest_entry", "quest_entry", "wpis_zadania");
...
{
	auto merger = make_merger_with_entry(rec_type_t::info, "T^background^info_001", "Hello there", "Witaj");
...
{
	auto merger = make_merger_with_entry(rec_type_t::info, "T^greetings^resp_42", "Good day", "Dzien dobry");
