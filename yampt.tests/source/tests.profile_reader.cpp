...
{
	const auto result = profile_reader_t::parse_openmw_cfg_text("data=/simple/path\n");
...
{
	const auto result =
	    profile_reader_t::parse_mo2_profile_text("plugin.esp\n", "+EnabledMod\n-DisabledMod\n+AnotherEnabled\n");
...
TEST_CASE("profile_reader_t::resolve_single_openmw_content, last data dir wins", "[u]")
{
	...
	const auto result =
	    profile_reader_t::resolve_single_openmw_content("Morrowind.esm", { "/data1", "/data2" }, file_exists);
...
TEST_CASE("profile_reader_t::resolve_single_openmw_content, returns empty when not found", "[u]")
{
	...
	const auto result =
	    profile_reader_t::resolve_single_openmw_content("Missing.esm", { "/data1", "/data2" }, file_exists);
...
TEST_CASE("profile_reader_t::resolve_openmw_content, resolves multiple plugins", "[u]")
{
	...
	const auto result = profile_reader_t::resolve_openmw_content(
	    { "Morrowind.esm", "Tribunal.esm", "Missing.esp" }, { "/data" }, file_exists);
...
TEST_CASE("profile_reader_t::resolve_mo2_plugin, overwrite has highest priority", "[u]")
{
	...
	const auto result = profile_reader_t::resolve_mo2_plugin(
	    "plugin.esp", "/overwrite", { "ModA" }, "/mods", "/game/Data Files", file_exists);
...
TEST_CASE("profile_reader_t::resolve_mo2_plugin, first mod in list wins", "[u]")
{
	...
	const auto result = profile_reader_t::resolve_mo2_plugin(
	    "plugin.esp", "/overwrite", { "ModA", "ModB" }, "/mods", "/game/Data Files", file_exists);
...
TEST_CASE("profile_reader_t::resolve_mo2_plugin, falls back to game data", "[u]")
{
	...
	const auto result = profile_reader_t::resolve_mo2_plugin(
	    "Morrowind.esm", "/overwrite", { "ModA" }, "/mods", "/game/Data Files", file_exists);
...
TEST_CASE("profile_reader_t::resolve_mo2_plugin, returns empty when not found", "[u]")
{
	...
	const auto result = profile_reader_t::resolve_mo2_plugin(
	    "missing.esp", "/overwrite", { "ModA" }, "/mods", "/game/Data Files", file_exists);
...
{
	const auto result =
	    profile_reader_t::resolve_merge_output_path(load_source_kind_t::folder, "C:/Games/Morrowind/Data Files");
...
{
	const auto result =
	    profile_reader_t::resolve_merge_output_path(load_source_kind_t::mo2_profile, "C:/MO2/profiles/Default");
...
{
	const auto result =
	    profile_reader_t::resolve_merge_output_path(load_source_kind_t::openmw_cfg, "/home/user/.config/openmw");
...
{
	const auto result = profile_reader_t::resolve_merge_output_path(load_source_kind_t::folder, "");
...
TEST_CASE("profile_reader_t::resolve_mo2_plugin, overwrite merged patch", "[u]")
{
	...
	auto resolved = profile_reader_t::resolve_mo2_plugin(
	    "Merged Patch.esp", "/MO2/overwrite", { "ModA" }, "/MO2/mods", "/game/Data Files", file_exists);
...
TEST_CASE("profile_reader_t::resolve_merge_output_path, session restore", "[i]")
{
	...
	auto merge_path = profile_reader_t::resolve_merge_output_path(load_source_kind_t::folder, base_path);
...
TEST_CASE("profile_reader_t::resolve_mo2_plugin, session restore overwrite", "[i]")
{
	...
	auto merge_path = profile_reader_t::resolve_merge_output_path(load_source_kind_t::mo2_profile, base_path);
...
TEST_CASE("profile_reader_t::resolve_merge_output_path, openmw session", "[i]")
{
	...
	auto merge_path = profile_reader_t::resolve_merge_output_path(load_source_kind_t::openmw_cfg, base_path);
