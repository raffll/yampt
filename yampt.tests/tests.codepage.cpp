...
TEST_CASE("codepage_t, decode/encode round-trip 1250", "[u]")
{
	// Full Polish sentence with diacritics
	std::string raw_1250 = "Zdr\xF3j wody"; // "Zdrój wody" (ó = 0xF3 in 1250)
...
TEST_CASE("codepage_t, decode/encode round-trip 1251", "[u]")
{
	// Cyrillic: "Привет" = CF F0 E8 E2 E5 F2 in Windows-1251
...
TEST_CASE("codepage_t, decode/encode round-trip 1252", "[u]")
{
	// French: "café" = 63 61 66 E9 in Windows-1252 (é = 0xE9)
