...
{
    dict_creator_t esm(g_masterPath + "en/Morrowind.esm");
    ...
    REQUIRE(cell->status == tools_t::Status::untranslated);
    ...
    REQUIRE(dial->status == tools_t::Status::untranslated);
    ...
    REQUIRE(indx->status == tools_t::Status::untranslated);
    ...
    REQUIRE(rnam->status == tools_t::Status::untranslated);
    ...
    REQUIRE(desc->status == tools_t::Status::untranslated);
    ...
    REQUIRE(gmst->status == tools_t::Status::untranslated);
    ...
    REQUIRE(fnam->status == tools_t::Status::untranslated);
    ...
    REQUIRE(info->status == tools_t::Status::untranslated);
    ...
    REQUIRE(text->status == tools_t::Status::untranslated);
}

TEST_CASE("make-base, same record order", "[i]")
{
    dict_creator_t esm(g_masterPath + "pl/Morrowind.esm", g_masterPath + "en/Morrowind.esm");
    const auto & dict = esm.get_dict();
...
{
    dict_creator_t esm(g_masterPath + "de/Morrowind.esm", g_masterPath + "en/Morrowind.esm");
    const auto & dict = esm.get_dict();
