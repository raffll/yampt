...
editor_controller_t::editor_controller_t(history_manager_t & history, validation_manager_t & validation,
...
commit_result_t editor_controller_t::commit(dict_document_t & doc, const table_row_t & row,
...
int editor_controller_t::propagate(dict_document_t & doc, const std::string & old_text,
                                   const std::string & new_text)
{
