	...
	for(size_t i = 0; i < esm.getRecColl().size(); ++i)
	{
		   ...
		   esm.getRecId() == "RACE")
		{
			...
			if(esm.getUniqueStatus() == true && esm.getFriendlyStatus() == true)
			{
				...
				makeLog("DESC " + esm.getRecId() + " " + esm.getUnique());
				if(convert == true)
				{
					convertRecordContent(new_friendly + '\0');
				}
		...
		if(esm.getRecId() == "FACT")
		{
			...
			if(esm.getUniqueStatus() == true)
			{
				while(esm.getFriendlyStatus() == true)
				{
					...
					makeLog("RNAM " + esm.getUnique() + to_string(esm.getFriendlyCounter());
					if(convert == true)
					{
	...
	for(size_t i = 0; i < esm.getRecColl().size(); ++i)
	{
		   ...
		   esm.getRecId() == "MGEF")
		{
			...
			if(esm.getUniqueStatus() == true && esm.getFriendlyStatus() == true)
			{
				...
				makeLog("INDX " + esm.getRecId() + " " + esm.getUnique());
				if(convert == true)
				{
					convertRecordContent(new_friendly + '\0');
				}
	...
	for(size_t i = 0; i < esm.getRecColl().size(); ++i)
	{
		...
		if(esm.getRecId() == "INFO")
		{
			...
			if(esm.getUniqueStatus() == true && esm.getFriendlyStatus() == true)
			{
				...
				makeLog("INFO " + current_dialog + " " + esm.getUnique());
				if(convert == true)
				{
					convertRecordContent(new_friendly + '\0');
				}
