    ...
    size_t data_size) const
{
	...
	if (schema)
	{
		...
		static const std::map<std::string, const char *> record_names = {
			...
			{ "APPA", "Apparatus" },    { "ARMO", "Armor" },
			{ "BOOK", "Book" },         { "CELL", "Cell" },
			{ "CLAS", "Class" },        { "CLOT", "Clothing" },
			{ "CONT", "Container" },    { "CREA", "Creature" },
			{ "ENCH", "Enchantment" },  { "FACT", "Faction" },
			{ "GLOB", "Global" },       { "INFO", "Info" },
			{ "INGR", "Ingredient" },   { "LEVI", "Leveled Item" },
			{ "LEVC", "Leveled Creature" }, { "LIGH", "Light" },
			{ "LOCK", "Lockpick" },     { "MGEF", "Magic Effect" },
			{ "MISC", "Misc Item" },    { "NPC_", "NPC" },
			{ "PROB", "Probe" },        { "RACE", "Race" },
			{ "REGN", "Region" },       { "REPA", "Repair Item" },
			{ "SCPT", "Script" },       { "SKIL", "Skill" },
