...
void book_preview_t::set_html(const std::string & original_html, const std::string & translation_html)
{
...
QString book_preview_t::prepare_html(const std::string & html) const
{
