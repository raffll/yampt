...
static constexpr std::array<std::string_view, 22> known_summon_ids = {
	"ancestor_ghost_summon", "atronach_flame_summon", "atronach_frost_summon",   "atronach_storm_summon",
	"bonelord_summon",       "bonewalker_summon",     "bonewalker_greater_summ", "centurion_sphere_summon",
	"clannfear_summon",      "daedroth_summon",       "dremora_summon",          "golden saint_summon",
	"hunger_summon",         "scamp_summon",          "skeleton_summon",         "ancestor_ghost_variner",
	"fabricant_summon",      "bm_bear_black_summon",  "bm_wolf_grey_summon",     "bm_wolf_bone_summon",
	"centurion_fire_dead",   "wraith_sul_senipul",
};
