...
static const std::map<std::pair<std::string, std::string>, const char *> & context_descriptions()
{
	static const std::map<std::pair<std::string, std::string>, const char *> descs = {
		...
		{ { "CELL", "XCHG" }, "Charge" },        { { "CELL", "XSOL" }, "Soul" },
		{ { "NPC_", "ANAM" }, "Faction" },        { { "NPC_", "BNAM" }, "Head Model" },
		{ { "NPC_", "CNAM" }, "Class" },          { { "NPC_", "DNAM" }, "Hair Model" },
		{ { "NPC_", "KNAM" }, "Hair" },           { { "NPC_", "CNDT" }, "Cell Travel" },
		{ { "INFO", "ANAM" }, "Cell" },           { { "INFO", "BNAM" }, "Result Script" },
		{ { "INFO", "CNAM" }, "Class" },          { { "INFO", "DNAM" }, "PC Faction" },
		{ { "INFO", "FNAM" }, "Faction" },        { { "INFO", "NAME" }, "Response" },
		{ { "INFO", "SNAM" }, "Sound File" },     { { "INFO", "RNAM" }, "Race" },
		{ { "DOOR", "SNAM" }, "Open Sound" },     { { "DOOR", "ANAM" }, "Close Sound" },
		{ { "FACT", "RNAM" }, "Rank Name" },      { { "FACT", "ANAM" }, "Reaction Faction" },
		...
		{ { "LEVC", "INDX" }, "Count" },          { { "LEVC", "INTV" }, "PC Level" },
		{ { "LEVI", "INAM" }, "Item" },           { { "LEVI", "NNAM" }, "Chance None" },
		{ { "LEVI", "INDX" }, "Count" },          { { "LEVI", "INTV" }, "PC Level" },
		{ { "BSGN", "TNAM" }, "Texture" },
		{ { "REGN", "BNAM" }, "Sleep Creature" }, { { "REGN", "CNAM" }, "Map Color" },
		{ { "REGN", "SNAM" }, "Sound Chance" },
		{ { "SNDG", "CNAM" }, "Creature" },       { { "SNDG", "SNAM" }, "Sound ID" },
		{ { "SOUN", "FNAM" }, "Sound File" },
		{ { "CREA", "CNAM" }, "Sound Gen Creature" },
		{ { "MGEF", "PTEX" }, "Particle Texture" },
		{ { "MGEF", "ASND" }, "Area Sound" },     { { "MGEF", "BSND" }, "Bolt Sound" },
		{ { "MGEF", "CSND" }, "Cast Sound" },     { { "MGEF", "HSND" }, "Hit Sound" },
		{ { "MGEF", "AVFX" }, "Area VFX" },       { { "MGEF", "BVFX" }, "Bolt VFX" },
		{ { "MGEF", "CVFX" }, "Cast VFX" },       { { "MGEF", "HVFX" }, "Hit VFX" },
		{ { "GLOB", "FNAM" }, "Type" },
		{ { "PGRD", "PGRP" }, "Points" },         { { "PGRD", "PGRC" }, "Connections" },
		{ { "ALCH", "TEXT" }, "Icon" },
		{ { "SCPT", "SCVR" }, "Variables" },      { { "SCPT", "SCDT" }, "Bytecode" },
		{ { "INFO", "INTV" }, "Comparison Value" },{ { "INFO", "FLTV" }, "Comparison Value" },
		{ { "CELL", "INTV" }, "Charge/Count" },   { { "CELL", "FLTV" }, "Lock Level" },
		{ { "CELL", "INDX" }, "Faction Index" },
		{ { "GMST", "STRV" }, "Value" },          { { "GMST", "INTV" }, "Value" },
		{ { "GMST", "FLTV" }, "Value" },
	};
	return descs;
}
